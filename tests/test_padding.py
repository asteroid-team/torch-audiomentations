...
class TestPadding(unittest.TestCase):
    ...
    def test_Padding_perexample(self):
        ...
        augment = Padding(min_fraction=0.2, max_fraction=0.5, pad_section="start",
                    p=0.5,mode="per_example",p_mode="per_example",output_type='dict')
    ...
    def test_Padding_perchannel(self):
        ...
        audio_samples = torch.rand(size=(10,2,32000), dtype=torch.float32)
        augment = Padding(min_fraction=0.2, max_fraction=0.5, pad_section="start",
                    p=0.5,mode="per_channel",p_mode="per_channel",output_type='dict')
    ...
    def test_Padding_cuda(self):
        ...
        audio_samples = torch.rand(size=(2,2,32000), dtype=torch.float32,device=torch.device('cuda'))
